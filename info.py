...
ADV_GRP = int(environ.get('ADV_GRP', '-1001885148325'))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+uRFM_Zc52GgzZmM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Filmy_Pitaara2')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https//:t.me/+uRFM_Zc52GgzZmM1')
